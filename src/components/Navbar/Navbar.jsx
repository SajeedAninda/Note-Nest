    ...
    <div className='bg-white'>
      <div className='w-full lg:w-[1300px] mx-auto px-6 lg:px-0 h-fit lg:h-[14vh] flex items-center'>
        ...
        <div className='w-[80%] flex justify-between items-center'>
          ...
          <button class='relative cursor-pointer inline-flex items-center justify-center px-12 py-3 overflow-hidden tracking-tighter text-white bg-[#242627] rounded-md group group'>
            <span class='absolute w-0 h-0 transition-all duration-500 ease-out bg-[#f7f8fa] rounded-full group-hover:w-56 group-hover:h-56 '></span>
            ...
            <span class='relative text-base font-semibold group-hover:text-[#242627]'>Login</span>
          </button>
        </div>
      </div>
    </div>
